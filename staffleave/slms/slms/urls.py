...
urlpatterns = [
    ...
    path('Admin/LeaveTypes', adminviews.LEAVE_TYPE_LIST, name='leave_type_list'),
    path('Admin/LeaveTypes/Add', adminviews.LEAVE_TYPE_ADD, name='leave_type_add'),
    path('Admin/LeaveTypes/Edit/<str:id>', adminviews.LEAVE_TYPE_EDIT, name='leave_type_edit'),
    path('Admin/LeaveTypes/Delete/<str:id>', adminviews.LEAVE_TYPE_DELETE, name='leave_type_delete'),
